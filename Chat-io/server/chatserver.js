...
io.on("connection", function(socket) {
  ...
  socket.on("createroom", function(joinObj, fn) {
    ...
    //If room isn't an empty string or undefined then consider adding it
    if (room) {
      if (rooms[room] === undefined) {
        ...
        fn(true); //room was created successfully
      }
    }
    fn(false); //room was taken or name was undefined/empty
  });
